...
df = df[df['Indicador'] == 'Visitantes extranjeros no residentes']
print (df)
...
with open('Dato_Num_2_hackaton.html', 'w') as f:
...
plt.title('Tendencias de visitantes extranjeros por año')
plt.xlabel('Año')
plt.ylabel('Dato_Num')
plt.grid(True)
plt.savefig('tendencias_visitas_extranjeros_hackaton.png')  # Guardar la imagen
plt.show()
