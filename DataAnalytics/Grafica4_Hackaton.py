...
df = df[df['Indicador'] == 'Turismo interno']
print (df)
...
with open('Dato_Num_4_hackaton.html', 'w') as f:
...
plt.title('Tendencias de Turistas internos por año')
plt.xlabel('Año')
plt.ylabel('Dato_Num')
plt.grid(True)
plt.savefig('tendencias_Turismo_interno_hackaton.png')  # Guardar la imagen
plt.show()
