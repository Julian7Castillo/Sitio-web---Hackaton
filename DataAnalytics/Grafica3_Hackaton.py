...
df = df[df['Indicador'] == 'Visitante interno']
print (df)
...
with open('Dato_Num_3_hackaton.html', 'w') as f:
...
plt.title('Tendencias de visitantes internos por año')
plt.xlabel('Año')
plt.ylabel('Dato_Num')
plt.grid(True)
plt.savefig('tendencias_visitas_internas_hackaton.png')  # Guardar la imagen
plt.show()
