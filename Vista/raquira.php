...
<body>
    <main>
        ...
        <div>
                <h2 class="centrar-texto fw-300" style="display:flex; flex-direction:column; align-items:center;">Raquira</h2>
                    <div>
                        <img src="img/destacada.jpg" alt="">
                    </div>
            
                    <div class="img-places" >
                        <img src="./Vista/img_place/raquira.jpg" alt="villa-de-leyva">
                    </div>
                ...
                <div class="contenedor elementos-anuncio">
                    ...
                    <br>
                    <div>
                        <h3 style="display:flex; flex-direction:column; align-items:center;">Lugares turisticos</h3>
                        <br>
                        <ul>
                            <li> Una visita a Ráquira no está completa si no se recorren lugares emblemáticos y tradicionales como el Monasterio y desierto de la Candelaria, declarado monumento nacional y bien de interés cultural de carácter nacional </li>
                            <li>la iglesia y el parque central, rodeados de esculturas elaboradas en arcilla y cerámica; el comercio y las casas multicolores, que están adornadas con artesanías de todo tipo en sus fachadas </li>
                            <li>
