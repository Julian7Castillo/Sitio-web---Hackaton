...
<html>
	<body class="contenedor">
        ...
        <main class="contenedor">
            <h2 class="seccion text-center fw-300">Lugares Turisticos </h2>
        ...
        <section class="contenedor">
            <h2 class="seccion text-center fw-300">Más Sobre Nosotros</h2>
            <div class="iconos-nosotros">
                <div class="icono">
                    <img src="Vista/img/turismo.png" alt="Icono turismo" class="img-nosotros">

                    <h3>TURISMO</h3>
                    <p>Descubra los destinos más emblemáticos, los rincones escondidos y las experiencias únicas que Boyacá y Cundinamarca tienen para ofrecer.</p>
                </div>
                ...
                <div class="icono">
                    ...
                    <h3>GASTRONOMIA</h3>
                    <p>Sumérjase en la rica tradición culinaria de la región, desde platos típicos hasta recomendaciones de los mejores restaurantes.</p>
                </div>
